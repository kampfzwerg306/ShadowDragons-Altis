...
switch(_type) do
{
  ...
  { 
    ...
    [[_msg,name _player,5],"clientMessage",east,false] spawn life_fnc_MP;
  };
  //adminToPerson
  case 4:
  {
  ...
  case 5:
  {
	...
	[[4,format ["Admin Ansprache: %1",_msg],false,"Admin"],"life_fnc_broadcast",true,false] call life_fnc_MP;
