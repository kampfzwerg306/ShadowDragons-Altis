...
while {true} do
{
	...
	*/
	...
	diag_log format["ALL MISSION OBJECTS THING : %1", allMissionObjects "Thing"];
	diag_log format["ALL MISSION OBJECTS THING COUNT : %1", count(allMissionObjects "Thing")];
	
	diag_log format["ALL MISSION OBJECTS GroundWeaponHolder : %1", allMissionObjects "GroundWeaponHolder"];
	diag_log format["ALL MISSION OBJECTS GroundWeaponHolder count : %1", count(allMissionObjects "GroundWeaponHolder")];
...
//	uiSleep (2 * 60);
	...
	diag_log format["2 ALL MISSION OBJECTS THING : %1", allMissionObjects "Thing"];
	diag_log format["2 ALL MISSION OBJECTS THING COUNT : %1", count(allMissionObjects "Thing")];
	
	diag_log format["2 ALL MISSION OBJECTS GroundWeaponHolder : %1", allMissionObjects "GroundWeaponHolder"];
	diag_log format["2 ALL MISSION OBJECTS GroundWeaponHolder count : %1", count(allMissionObjects "GroundWeaponHolder")];
};