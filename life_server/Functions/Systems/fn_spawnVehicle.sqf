...
_vehicle lock 2;
//Reskin the vehicle 
//diag_log "RESKINN THE VEHICLE:";
//diag_log format["RESKINN THE VEHICLE WITH VALUES: %1, %2:", _vehicle, (_vinfo select 8)];
...
if((_vInfo select 1) == "civ" && (_vInfo select 2) == "O_G_Offroad_01_F" && _vInfo select 8 != 13) then
{
	[[_vehicle,"five0_offroad",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};
...
if(_vehicle in ["B_Heli_Light_01_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_03_unarmed_F","O_MRAP_02_F"]) then {
