...
["CALL repairVehiclesCrap",1] spawn DB_fnc_asyncCall;
["CALL deleteMessages",1] spawn DB_fnc_asyncCall;
...
_handle = [] execVM "\life_server\Functions\Hero\fn_fetchPlayerVehicle.sqf";
