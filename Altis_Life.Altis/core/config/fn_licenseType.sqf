...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "adac_air": {_var = "license_adac_air"};
			case "adac_truck": {_var = "license_adac_truck"};
			case "adac_driver": {_var = "license_adac_driver"};
			
			//jagen neue jobs etc
			case "hunter": {_var = "license_civ_hunter"};
			case "sheep": {_var = "license_civ_sheep"};
			case "goat": {_var = "license_civ_goat"};
			case "chicken": {_var = "license_civ_chicken"};
			case "keks": {_var = "license_civ_keks"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_adac_air": {_var = "adac_air"};
			case "license_adac_truck": {_var = "adac_truck"};
			case "license_adac_driver": {_var = "adac_driver"};
			
			//jagd neue jobs
			case "license_civ_hunter": {_var = "hunter"};
			case "license_civ_sheep": {_var = "sheep"};
			case "license_civ_goat": {_var = "goat"};
			case "license_civ_chicken": {_var = "chicken"};
			case "license_civ_keks": {_var = "keks"};
