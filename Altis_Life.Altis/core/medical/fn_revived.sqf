...
switch(playerSide) do {
	case independent: {
		[[player,0,"textures\MED\U_IG_Guerilla2.paa"], "life_fnc_setTexture",true,false] spawn life_fnc_MP;};
};
...
life_corpse setVariable["life_player_alive",TRUE,TRUE];
...
player setVariable["life_player_alive", TRUE,TRUE];
