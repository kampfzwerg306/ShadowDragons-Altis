...
/* if (_curTarget isKindOf "House_F") && (__GETC__(life_coplevel) > 5) exitWith {
...
if(!((player distance (getMarkerPos "police_hq_1") < 50) OR  (player distance (getMarkerPos "police_hq_2") < 50) OR (player distance (getMarkerPos "cop_spawn_2") < 50) OR (player distance (getMarkerPos "cop_spawn_3") < 50) OR (player distance (getMarkerPos "cop_spawn_5") < 50))) then 
{
