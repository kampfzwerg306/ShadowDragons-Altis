...
if((playerSide in [west, east])) then {
	...
	if(life_inv_reifen >= 1) then {
		_Btn9 ctrlSetText "Reifen Wechseln";
		_Btn9 buttonSetAction "[life_vInact_curTarget] spawn nok_fnc_reifen;closeDialog 0;";
	} else { _Btn9 ctrlShow false;};
