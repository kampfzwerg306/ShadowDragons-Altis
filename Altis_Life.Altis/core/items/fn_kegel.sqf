...
life_action_kegelDeploy = player addAction["<t color='#00FF00'>Kegel aufstellen</t>",{if(!isNull life_kegel) then {detach life_kegel; life_kegel = ObjNull;}; player removeAction life_action_kegelDeploy; life_action_kegelDeploy = nil;},"",999,false,false,"",'!isNull life_kegel'];
life_kegel = _kegel;
