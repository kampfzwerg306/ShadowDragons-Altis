...
*/
private["_vault","_handle","_cops"];

_cops = (west countSide playableUnits);

{

	is_five0 = _x getVariable["is_member_of_life_gang_five0",false];
	if (is_five0) then {
		_cops = _cops + 1;
	};  
...
if(_cops < 5) exitWith{[[_vault,-1],"disableSerialization;",false,false] spawn life_fnc_MP; hint "Es ist nicht genug Polizei vorhanden um einen Überfall durchzuführen.!";};
