...
if(life_session_tries > 4) exitWith {cutText[localize "STR_Session_Error","BLACK FADED"]; 0 cutFadeOut 999999999;};
...
diag_log "REQUEST RECEIVED  - CONTINUE NOW";
life_session_completed_query_one = true;
