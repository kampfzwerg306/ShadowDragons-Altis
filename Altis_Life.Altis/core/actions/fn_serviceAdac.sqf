...
_search = nearestObjects[getPos adac_sp, ["Car"],40];
...
if(!alive (_search select 0) || (_search select 0) distance adac_sp > 10) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing";5 cutText ["","PLAIN"];};
