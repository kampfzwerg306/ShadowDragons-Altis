...
tawvd_syncObject = profileNamespace getVariable ["tawvd_syncObject",false];
tawvd_object = profileNamespace getVariable ["tawvd_object",1600];
...
tawvd_gras = profileNamespace getVariable ["tawvd_gras",""];
[] call life_fnc_updateViewDistance;
[tawvd_gras] call life_fnc_onTerrainChanged;
...
// here we call the player information from Database
...
_handle = execVM "core\fn_addKey.sqf";///here
waitUntil {scriptDone _handle};
