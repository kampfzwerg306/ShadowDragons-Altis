...
switch(_type) do
{
  ...
  case 1:
  {
    ...
    if(_msg == "") exitWith {hint "Eine leere Nachricht wird nicht gesendet!";ctrlShow[88885, true];};
  ...
  case 2:
  {
    ...
    if(_msg == "") exitWith {hint "Eine leere Nachricht wird nicht gesendet!";ctrlShow[888895,true];};
  ...
  case 3:
  {
    ...
    if(_msg == "") exitWith {hint "Eine leere Nachricht wird nicht gesendet!";ctrlShow[888896,true];};
  ...
  case 4:
  {
    ...
    if(_msg == "") exitWith {hint "Eine leere Nachricht wird nicht gesendet!";ctrlShow[888899,true];};
