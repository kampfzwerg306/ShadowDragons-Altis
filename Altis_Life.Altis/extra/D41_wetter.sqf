		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN <= 10) then
					{
						...
						if(D41_WMod == 0)	then {D41_Nebel = [0.2, 0.1,10];		D41_Regen = 0.1;	D41_Vorschau = 0.4;}; //Dicht
						if(D41_WMod == 1)	then {D41_Nebel = [0.2, 0.2,10];		D41_Regen = 0.2;	D41_Vorschau = 0.3;};
						if(D41_WMod == 2)	then {D41_Nebel = [0.2, 0.3,10];		D41_Regen = 0.2;	D41_Vorschau = 0.2;}; //geht so, akzeptabler Nebel
						if(D41_WMod == 3)	then {D41_Nebel = [0.4, 0.1,15];	D41_RegenCounter = 0;}; //Dicht
						if(D41_WMod == 4)	then {D41_Nebel = [0.4, 0.1,15];	D41_Regen = 0.2;	D41_Vorschau = 0.4;};
						if(D41_WMod == 5)	then {D41_Nebel = [0.4, 0.1,15];	D41_RegenCounter = 0;}; //geht so, akzeptabler Nebel
				...
				if(D41_ChanceN >=11 && D41_ChanceN <= 30 && D41_RegenCounter == 0) then
					{
						...
						D41_WMod = round(random 9);
						if(D41_WMod == 0)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 1; 	D41_Wind = [6, 6, true];	D41_Regen = 0.6;};
						if(D41_WMod == 1)	then {D41_Nebel = 0.3;	D41_Wellen = 1;		D41_Vorschau = 1; 	D41_Wind = [9, 9, true];	D41_Regen = 0.6;};
						if(D41_WMod == 2)	then {D41_Nebel = 0.1;	D41_Wellen = 1;		D41_Vorschau = 0.9; D41_Wind = [2, 2, true];	D41_Regen = 0.5;};
						if(D41_WMod == 3)	then {D41_Nebel = 0.2;	D41_Wellen = 0.8;	D41_Vorschau = 0.8; D41_Wind = [0, 5, true];	D41_Regen = 0.5;};
						if(D41_WMod == 4)	then {D41_Nebel = 0.1;	D41_Wellen = 0.8;	D41_Vorschau = 0.7; D41_Wind = [2, 0, true];	D41_Regen = 0.3;};
						if(D41_WMod == 5)	then {D41_Nebel = 0.1;	D41_Wellen = 0.6;	D41_Vorschau = 0.7; D41_Wind = [0, 6, true];	D41_Regen = 0.3;};
						if(D41_WMod == 6)	then {D41_Nebel = 0.1;	D41_Wellen = 0.4;	D41_Vorschau = 0.6; D41_Wind = [7, 0, true];	D41_Regen = 0.2;};
				...
				if(D41_ChanceN >=31 && D41_ChanceN <= 90) then
				{
					...
					if(D41_WMod == 1)	then {D41_Vorschau = 0.9;	D41_Wind = [0, 4, true];};
					if(D41_WMod == 2)	then {D41_Vorschau = 0.7;	D41_Wind = [5, 9, true];};
					if(D41_WMod == 3)	then {D41_Vorschau = 0.7;	D41_Wind = [4, 5, true];};
					if(D41_WMod == 4)	then {D41_Vorschau = 0.6;	D41_Wind = [0, 2, true];};
				...
				if(D41_ChanceN >=91 && D41_ChanceN <= 100) then
				{
					...
					if(D41_WMod == 0)	then {D41_Vorschau = 0.2;	D41_Wind = [2, 0, true];};
					if(D41_WMod == 1)	then {D41_Vorschau = 0.2;	D41_Wind = [0, 6, true];};
