...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base", "B_Heli_Transport_03_unarmed_F"];
	...
	IL_Supported_Ifrit = ["O_MRAP_02_F", "O_MRAP_02_gmg_F", "O_MRAP_02_hmg_F", "C_Heli_Light_01_civil_F", "I_Heli_light_03_unarmed_F", "B_Heli_Light_01_F"];
	IL_Supported_UGV = ["B_UGV_01_rcws_F", "B_UGV_01_F", "O_UGV_01_rcws_F", "O_UGV_01_F", "I_UGV_01_rcws_F", "I_UGV_01_F"];
	IL_Supported_VAN = ["O_G_Van_01_fuel_F", "C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F"];
	...
	IL_Supported_Rubberboat = ["C_Boat_Civil_01_F", "I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F"];
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Ifrit + IL_Supported_Strider + IL_Supported_Hunter;
...
//	END IL_Move_Attach
	...
	IL_Create_And_Attach =
	{
		...
		[[_type, position _to,0,"CAN_COLLIDE",Player],"life_fnc_createvehicle",false,false] spawn life_fnc_MP;
		waituntil {!isnil "nok_createvehicle"};
		_m = nok_createvehicle;
...
//	END IL_Create_And_Attach
	...
	//	_chute = createVehicle ["NonSteerable_Parachute_F", position _cargo, [], 0, "CAN_COLLIDE"];
		...
		[["B_Parachute_02_F", position _cargo,0,"CAN_COLLIDE",Player],"life_fnc_createvehicle",false,false] spawn life_fnc_MP;
		waituntil {!isnil "nok_createvehicle"};
		_chute = nok_createvehicle;
		nok_createvehicle = nil;
		...
		{
			_smoke = [_smoke_type, _cargo] spawn IL_Create_And_Attach;
			waituntil {scriptdone _smoke};
		};
		if (IL_Para_Light) then
		{
			_light = [_chemlight_type, _cargo] spawn IL_Create_And_Attach;
			waituntil {scriptdone _light};
		};
...
//	END IL_Do_Unload
	...
	IL_GetOut =
	{
		...
		else
		{
			...
			{
				[["Steerable_Parachute_F", position _player,0,"CAN_COLLIDE",Player],"life_fnc_createvehicle",false,false] spawn life_fnc_MP;
				waituntil {!isnil "nok_createvehicle"};
				_chute = nok_createvehicle;
				nok_createvehicle = nil;
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	if (typeOf _obj_main == "CH_147F") then
	{
		...
		_obj_main addAction [
		"<img image='extraIgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute</t>",
		{
			[_this select 0, true] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
